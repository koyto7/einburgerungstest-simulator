...
When run directly, writes questions.json.
When imported, call merge() to get the merged data as a list.
"""
import json
import glob
import os
...
def merge() -> list[dict]:
    """Merge PDF questions with scraped answers and return the result."""
...
def main():
    ...
    out.write_text(
        json.dumps(pdf_questions, ensure_ascii=False, indent=2), encoding="utf-8"
    )
